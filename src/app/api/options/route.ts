...
export async function GET() {
  const [users, modules, natures, statuses, stageGroups, stageTemplates] = await Promise.all([
  ...
  return NextResponse.json({ users, modules, natures, statuses, stageGroups, stageTemplates });
}
